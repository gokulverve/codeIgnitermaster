        ...
        <tr bgcolor="#F1F2F7">
            <td align="center" bgcolor="#F1F2F7" valign="top" width="100%">
                ...
                <table class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                    <tbody>
                        <tr bgcolor="FD4F00"><td height="15"></td></tr>
                        <tr bgcolor="FD4F00">
                            <td align="center">
                                <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                                    <tbody>
                                        <tr bgcolor="FD4F00"><td height="5"></td></tr>
                                        <tr bgcolor="FD4F00">
                                            <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
                                            <img  style="display: block;" src="<?php echo HTTP_IMAGES_PATH?>logo.png" alt="<?php echo PROJECT_NAME;?>" width="150"></td>
                                        </td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="FD4F00" height="5"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        </tr>
                        <tr bgcolor="FD4F00"><td height="10"></td></tr>
                    </tbody>
                </table>
                <!--  end top header  -->
                <!-- main content -->
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">Hello <?php echo $NAME;?>,</td>
                                                                </tr>
                                                                <tr><td height="10"></td></tr>
                                                                <tr>
                                                                    <td  style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;"> Thank you for contact to
                                                                ...
                                                                <tr>
                                                                    <td  style="color: #a4a4a4; line-height: 25px; font-size: 12px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                                        The email confirms that your password has been sent.
                                                                        To log on in the web panel, use the following password.
                                                                        <br>
                                                                        <?php if (isset($EMAIL_ID) && $EMAIL_ID != ""){?>
                                                                        <h2><b>User : </b><?php echo $EMAIL_ID; ?><h2><?php } ?>
                                                                        <h2><b>Password : </b><?php echo $PASSWORD; ?><h2>
                                                                    </td>
                                                                </tr>
                                                                <tr><td height="15"></td></tr>
                                                                <tr>
                                                                    <td>
                                                                        <a href="<?php echo $LOGIN_LINK;?>" style="background-color: #FD4F00; font-size: 12px; padding: 10px 15px; color: #fff; text-decoration: none" target="new"> Click on >> </a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                ...
                <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                    <tbody>
                        ...
                        <tr bgcolor="FD4F00">
                            <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
                                <?php echo PROJECT_NAME;?> © Copyright . All Rights Reserved
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="FD4F00" height="14"></td>
                        </tr>
                    </tbody></table>
                    <!-- end footer-->
                </td>
